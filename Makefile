#############################################################################
# Makefile for building: Protocol
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  Protocol.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Protocol.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_QML_DEBUG -DQT_DECLARATIVE_DEBUG -DQT_WIDGETS_LIB -DQT_XML_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
$(TARGET): ui_mainwindow.h ui_addDialog.h ui_aboutdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)
	{ test -n "$(DESTDIR)" && DESTDIR="$(DESTDIR)" || DESTDIR=.; } && test $$(gdb --version | sed -e 's,[^0-9][^0-9]*\([0-9]\)\.\([0-9]\).*,\1\2,;q') -gt 72 && gdb --nx --batch --quiet -ex 'set confirm off' -ex "save gdb-index $$DESTDIR" -ex quit '$(TARGET)' && test -f $(TARGET).gdb-index && objcopy --add-section '.gdb_index=$(TARGET).gdb-index' --set-section-flags '.gdb_index=readonly' '$(TARGET)' '$(TARGET)' && rm -f $(TARGET).gdb-index || true

Makefile: Protocol.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Protocol.pro
...
dist: 
	@test -d .tmp/Protocol1.0.0 || mkdir -p .tmp/Protocol1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Protocol1.0.0/ && $(COPY_FILE) --parents mainwindow.h addDialog.h aboutdialog.h .tmp/Protocol1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp addDialog.cpp aboutdialog.cpp .tmp/Protocol1.0.0/ && $(COPY_FILE) --parents mainwindow.ui addDialog.ui aboutdialog.ui .tmp/Protocol1.0.0/ && (cd `dirname .tmp/Protocol1.0.0` && $(TAR) Protocol1.0.0.tar Protocol1.0.0 && $(COMPRESS) Protocol1.0.0.tar) && $(MOVE) `dirname .tmp/Protocol1.0.0`/Protocol1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Protocol1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_mainwindow.cpp moc_addDialog.cpp moc_aboutdialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_addDialog.cpp moc_aboutdialog.cpp
...
moc_addDialog.cpp: /usr/include/qt5/QtWidgets/QDialog \
		/usr/include/qt5/QtWidgets/qdialog.h \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		/usr/include/qt5/QtCore/qglobal.h \
...
compiler_uic_make_all: ui_mainwindow.h ui_addDialog.h ui_aboutdialog.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_addDialog.h ui_aboutdialog.h
ui_mainwindow.h: mainwindow.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic mainwindow.ui -o ui_mainwindow.h

ui_addDialog.h: addDialog.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic addDialog.ui -o ui_addDialog.h
