...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Protocol1.0.0/ && $(COPY_FILE) --parents mainwindow.h addDialog.h .tmp/Protocol1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp addDialog.cpp .tmp/Protocol1.0.0/ && $(COPY_FILE) --parents mainwindow.ui addDialog.ui .tmp/Protocol1.0.0/ && (cd `dirname .tmp/Protocol1.0.0` && $(TAR) Protocol1.0.0.tar Protocol1.0.0 && $(COMPRESS) Protocol1.0.0.tar) && $(MOVE) `dirname .tmp/Protocol1.0.0`/Protocol1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Protocol1.0.0
